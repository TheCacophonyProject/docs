    ...
    Jconfirm.prototype = {
        ...
        _setButtons: function () {
            ...
            $.each(this.buttons, function (key, button) {
                ...
                //iusvar 9giu2017
                var button_element = $('<button '+that.buttons[key].id+'type="button"'+that.buttons[key].btnData+' class="btn ' + that.buttons[key].btnClass + '">' + that.buttons[key].text + '</button>').click(function (e) {
                    e.preventDefault();
